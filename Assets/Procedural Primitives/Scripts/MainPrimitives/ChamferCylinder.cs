...
namespace ProceduralPrimitivesUtil
{
    public class ChamferCylinder : PPBase
    {
        ...
        protected override void CreateMesh()
        {
            ...
            if (flatFillet)
            {
                CreateCone(pivotOffset + m_rotation * new Vector3(0.0f, -heightHalf + fillet * 0.5f, 0.0f), m_rotation * Vector3.forward, m_rotation * Vector3.right, fillet, radiusFillet, radius, sides, filletSegs, sliceOn, sliceFrom, sliceTo, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(0.0f, 0.0f), tilingTorus, flipNormals, smooth);
                CreateCone(pivotOffset + m_rotation * new Vector3(0.0f, heightHalf - fillet * 0.5f, 0.0f), m_rotation * Vector3.forward, m_rotation * Vector3.right, fillet, radius, radiusFillet, sides, filletSegs, sliceOn, sliceFrom, sliceTo, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(0.0f, 0.5f), tilingTorus, flipNormals, smooth);
            }
            else
            {
            ...
            if (sliceOn)
            {
                ...
                //corner
                int cornerSide = flatFillet ? 1 : filletSegs;
                CreateCircle(pivotOffset + m_rotation * new Vector3(centerFrom.x * radiusFillet, heightHalfFillet, centerFrom.z * radiusFillet),  m_rotation * Vector3.up, m_rotation * -centerFrom.normalized, fillet, cornerSide, filletSegs, true, 270.0f, 360.0f, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(-radiusFillet / (radius * 2), heightHalfFillet / height),  tilingCircle, flipNormals);
                CreateCircle(pivotOffset + m_rotation * new Vector3(centerFrom.x * radiusFillet, -heightHalfFillet, centerFrom.z * radiusFillet), m_rotation * Vector3.up, m_rotation * -centerFrom.normalized, fillet, cornerSide, filletSegs, true, 180.0f, 270.0f, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(-radiusFillet / (radius * 2), -heightHalfFillet / height), tilingCircle, flipNormals);
                CreateCircle(pivotOffset + m_rotation * new Vector3(centerTo.x * radiusFillet, heightHalfFillet, centerTo.z * radiusFillet),      m_rotation * Vector3.up, m_rotation * centerTo.normalized,    fillet, cornerSide, filletSegs, true, 0.0f,   90.0f,  generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(radiusFillet / (radius * 2),  heightHalfFillet / height),  tilingCircle, flipNormals);
                CreateCircle(pivotOffset + m_rotation * new Vector3(centerTo.x * radiusFillet, -heightHalfFillet, centerTo.z * radiusFillet),     m_rotation * Vector3.up, m_rotation * centerTo.normalized,    fillet, cornerSide, filletSegs, true, 90.0f,  180.0f, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(radiusFillet / (radius * 2),  -heightHalfFillet / height), tilingCircle, flipNormals);
            }
        }
    }
}