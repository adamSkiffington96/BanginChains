...
namespace ProceduralPrimitivesUtil
{
    public class ChamferPlane : PPBase
    {
        ...
        protected override void CreateMesh()
        {
            ...
            //center
            CreatePlane(pivotOffset + Vector3.zero, m_rotation * Vector3.forward, m_rotation * Vector3.right, widthFillet, lengthFillet, widthSegs, lengthSegs, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(filletHalf / widthHalf, filletHalf / lengthHalf), tilingcenter, flipNormals);

            //top bottom
            CreatePlane(pivotOffset + m_rotation * new Vector3(0.0f, 0.0f, lengthHalfFilletHalf),  m_rotation * Vector3.forward, m_rotation * Vector3.right, widthFillet, fillet, widthSegs, filletSegs, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(filletHalf / widthHalf, (length - fillet) / length), tilingtb, flipNormals);
            CreatePlane(pivotOffset + m_rotation * new Vector3(0.0f, 0.0f, -lengthHalfFilletHalf), m_rotation * Vector3.forward, m_rotation * Vector3.right, widthFillet, fillet, widthSegs, filletSegs, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(filletHalf / widthHalf, 0.0f),                       tilingtb, flipNormals);

            //left right
            CreatePlane(pivotOffset + m_rotation * new Vector3(-widthHalfFilletHalf, 0.0f, 0.0f), m_rotation * Vector3.forward, m_rotation * Vector3.right, fillet, lengthFillet, filletSegs, lengthSegs, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2(0.0f, filletHalf / lengthHalf),                     tilinglr, flipNormals);
            CreatePlane(pivotOffset + m_rotation * new Vector3(widthHalfFilletHalf, 0.0f, 0.0f),  m_rotation * Vector3.forward, m_rotation * Vector3.right, fillet, lengthFillet, filletSegs, lengthSegs, generateMappingCoords, realWorldMapSize, UVOffset + new Vector2((width - fillet) / width, filletHalf / lengthHalf), tilinglr, flipNormals);
